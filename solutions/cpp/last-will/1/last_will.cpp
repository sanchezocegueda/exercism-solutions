...
namespace estate_executor {
    ...
    int assemble_code(int secret_modifier) {
        int blue_sum = khan::blue::code_fragment() + zhang::blue::code_fragment() + garcia::blue::code_fragment();
        int red_sum = khan::red::code_fragment() + zhang::red::code_fragment() + garcia::red::code_fragment();
